  ...
  return (
    <section className="relative z-20 px-6">
      <div className="max-w-4xl mx-auto flex flex-col gap-16 sm:gap-24 text-center items-center">
        ...
        >
          <h3 className="text-3xl sm:text-4xl lg:text-[2.5rem] font-bold tracking-tightest text-white leading-tight mb-4">
            What Selfera is
          </h3>
          <span className="text-lg sm:text-xl font-semibold tracking-tight text-[#00f5c0] drop-shadow-[0_0_8px_rgba(0,245,192,0.2)] mb-6 block">
            Enterprise-Level AI. Built for Small Businesses.
          </span>
          <div className="text-base sm:text-lg text-emerald-100/80 leading-relaxed space-y-4 font-normal max-w-2xl">
            <p>
        ...
        >
          ...
          <div className="text-base sm:text-lg text-emerald-100/80 leading-relaxed font-normal max-w-2xl">
            <p>
