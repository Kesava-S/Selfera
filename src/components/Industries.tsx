        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {INDUSTRIES.map((ind, i) => (
            <motion.div
              ...
              className="relative flex flex-col items-center justify-center p-6 sm:p-8 rounded-[28px] border border-ink/5 bg-white/40 backdrop-blur-sm hover:border-brand-blue/20 hover:bg-white transition-all duration-300 hover:shadow-[0_16px_40px_-16px_rgba(0,113,227,0.1)] hover:-translate-y-1 group select-none"
            >
              {/* Icon slot */}
